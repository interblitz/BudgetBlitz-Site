...
4. Added common data import dialog for loading CSV, OFX, push or sms notifications and backups from third party apps using Share option.
5. Improved Turnovers report.
6. Filters extended.
7. Added many minor improvements.
