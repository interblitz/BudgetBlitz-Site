...
'header_links' : [
        (u'Home', 'index', False, ''),
        (u'Changes', 'changes', False, ''),
        (u'Support us', 'support-us', False, ''),
        (u'Manual', 'https://interblitz.github.io/BudgetBlitz-Manual/en/build/html/index.html', True, ''),
        (u'Help', 'http://qa.bbmoney.biz/en', True, ''),
        (u'Privacy', 'privacy', False, '')
    ],
